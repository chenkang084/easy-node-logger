...
['debug', 'info', 'warn', 'error'].forEach(function (type, index) {
    Logger.prototype[type] = function () {
        ...
        var _a = this.loggerOptions, projectName = _a.projectName, environment = _a.environment, logFilePath = _a.logFilePath, momentFormat = _a.momentFormat, level = _a.level;
